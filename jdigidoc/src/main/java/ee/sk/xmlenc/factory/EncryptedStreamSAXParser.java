...
public class EncryptedStreamSAXParser
  ...
  /**
   * Initializes the Recipient atribute value used for locating the right <EncryptedKey> to be used for deryption
   *
   ...
   * @param recipientName Recipient atribute value of <EncryptedKey> used to locate the correct transport key to decrypt with
   *
